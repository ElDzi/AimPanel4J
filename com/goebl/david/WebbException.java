...
/**
 * Runtime exception wrapping the real exception thrown by HttpUrlConnection et
 * al.
 *
 * @author hgoebl
 */
public class WebbException extends RuntimeException {
	 ...
	 *
	 * @return the <code>Response</code> object filled with error information
	 *         like statusCode and errorBody.
	 */
