...
public class RetryManager {
	 ...
	 * @return <tt>true</tt> only in case of temporary (server-side) errors
	 *         where retrying the request could succeed.
	 */
	 ...
	 * <br>
	 * This is not covering all situations and in case of doubt the exception is
	 * considered not recoverable. @YOU: if you find a case where an exception
	 * is recoverable, create an issue!
	 * 
	 * @param webbException
	 *            the exception to analyze
	 * @return <tt>true</tt> if it makes sense for the request to be retried
	 *         again.
	 */
	...
	/**
	 * Implementation for the actual wait (depends on the current retry
	 * sequence).
	 * 
	 * @param retry
