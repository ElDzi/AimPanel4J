...
public class Response<T> {
	...
	/**
	 * Access to the <code>Request</code> object (which will not be very useful
	 * in most cases).
	 * 
	 * @return the request object which was responsible for creating this
	 *         response.
	 */
	 ...
	 * <ul>
	 * <li><code>Content-Type</code> header (overrules the expected return type
	 * of the response)</li>
	 * <li>The expected type (see <code>asXyz()</code>). We try to coerce the
	 * error body to this type. In case of REST services, where often a
	 * JSONObject is the normal response body, the error body will be converted
	 * to JSONObject if possible. <code>JSONArray</code> is not expected to be
	 * the error body.</li>
	 * </ul>
	 * If converting the error body is not successful, <code>String</code> and
	 * <code>byte[]</code> is used as a fallback. You have to check the type
	 * with <code>instanceof</code> or try/catch the cast.
	 * 
	 * @return the error body converted to an object (see above) or
	 *         <code>null</code> if there is no body or no error.
	 */
	...
	/**
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/HttpURLConnection.html#responseCode">
	 ...
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getContentType()">
	 ...
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getDate()">
	 * URLConnection.getDate()</a>
	 *
	 * @return the parsed "Date" header as millis or <code>0</code> if this
	 *         header was not set.
	 */
	public long getDate() {
	 ...
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getExpiration()">
	 ...
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getLastModified()">
	 ...
	 * See <a href=
	 * "http://docs.oracle.com/javase/7/docs/api/java/net/URLConnection.html#getHeaderField(java.lang.String)">
	 ...
	 * In many cases you will call
	 * {@link com.goebl.david.Request#ensureSuccess()} instead of this method.
	 * But there might be cases where you want to inspect the response-object
